...
import com.example.administrator.applicationtest2.view.test.video2.CameraTakeActivity;
...
public final class CaptureActivityHandler extends Handler {
    ...
    private State state;
    private CameraTakeActivity activity;
    ...
    public CaptureActivityHandler(CameraTakeActivity activity, String characterSet) {
