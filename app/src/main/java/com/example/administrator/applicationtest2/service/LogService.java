...
public class LogService extends Service {
    ...
    private void init(){
        LOG_PATH_MEMORY_DIR = Environment.getExternalStorageDirectory().toString() + "/Log/Test";//getFilesDir().getAbsolutePath() + File.separator + "log";
        LOG_SERVICE_LOG_PATH = LOG_PATH_MEMORY_DIR + File.separator + logServiceLogName;
        LOG_PATH_SDCARD_DIR = Environment.getExternalStorageDirectory().toString() + "/Log/Test"//Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator
