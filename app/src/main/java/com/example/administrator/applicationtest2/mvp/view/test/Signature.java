package com.example.administrator.applicationtest2.mvp.view.test;
...
//                        finish();
                ...
                case R.id.test_signature_btnBgColor:
                    dialog2 = new ColorSelectDialog(Signature.this, "背景颜色", new ColorSelectDialog.OnColorChangedListener() {
                        @Override
                        public void colorChanged(int color) {
