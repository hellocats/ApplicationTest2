...
public class SPUtils {
     ...
     */
    public void setUserLoginStr(String pwd) {
        if (editor != null) {
            editor.putString("userLogin", pwd);
            editor.commit();
        }
    }
    ...
    public void setUserDeptFlag(String DeptFlagStr) {
        if (editor != null) {
            editor.putString("DeptFlagStr", DeptFlagStr);
            editor.commit();
        }
    }
    ...
    public String getUserDeptFlag() {
        if (sp != null) {
            return sp.getString("DeptFlagStr", "");
        } else {
            return "";
        }
    }
    ...
    public void setUserUnitFlag(String UnitFlagStr) {
        if (editor != null) {
            editor.putString("UnitFlagStr", UnitFlagStr);
            editor.commit();
        }
    }
    ...
    public String getUserUnitFlag() {
        if (sp != null) {
            return sp.getString("UnitFlagStr", "");
        } else {
            return "";
        }
    }
    ...
    public void setUserUnitName(String UnitNameStr) {
        if (editor != null) {
            editor.putString("UnitNameStr", UnitNameStr);
            editor.commit();
        }
    }
    ...
    public String getUserUnitName() {
        if (sp != null) {
            return sp.getString("UnitNameStr", "");
        } else {
            return "";
        }
    }
