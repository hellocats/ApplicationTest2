...
import com.example.administrator.applicationtest2.common.mediautils.MediaUtils;
import com.example.administrator.applicationtest2.common.mediautils.SendView;
...
//        startActivity(new Intent(this,VPlayActivity.class).putExtra("path",videoPath));
    }
}
